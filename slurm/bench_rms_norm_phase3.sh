#!/bin/bash
#SBATCH --job-name=kernelserve-rms-norm-phase3
...
echo "=== rms-norm correctness check ==="
...
# ── Run Phase 3 benchmark: 3 backends × 3 shapes → MLflow + OTel spans ───────
echo "=== Phase 3 benchmark (3 backends × 3 shapes) ==="
