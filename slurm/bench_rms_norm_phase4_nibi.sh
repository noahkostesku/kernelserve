...
export LIBCLANG_PATH=/cvmfs/soft.computecanada.ca/easybuild/software/2023/x86-64-v4/Compiler/gcccore/clang/18.1.8/lib
export CUDA_OXIDE_LLC=/cvmfs/soft.computecanada.ca/easybuild/software/2023/x86-64-v4/Compiler/gcccore/llvmcore/21.1.5/bin/llc
...
srun --export=ALL python "$REPO_DIR/experiments/bench_rms_norm.py"
